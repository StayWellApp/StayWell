...
/**
 * Creates a standardized activity log entry in a subcollection under the user.
 * @param {string} clientId The UID of the client the log is for.
 * @param {string} type A category for the event (e.g., 'USER_CREATED', 'SUBSCRIPTION_UPDATED').
...
// --- END: NEW ACTIVITY LOG FUNCTIONS ---
